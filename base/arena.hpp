...
// TODO: May change this to be user definable
static constexpr U32 SCRATCH_ARENA_COUNT = 2;
static constexpr U64 SCRATCH_ARENA_SIZE = 64 * 1024 * 1024; // 64MB each

ArenaTemp get_scratch(Arena **conflicts, U64 conflict_count);
ArenaTemp get_scratch();
ArenaTemp get_scratch(Arena *conflict1);
void release_scratch(ArenaTemp temp);

#define ReleaseScratch(t) release_scratch(t)
